...
class GreedyChecker():
    ...
    def reinit_greedy(self):
        ...
        self.decision_cells = np.zeros((self.env.height, self.env.width, 4), dtype=bool)
        ...
        self.location_has_target_array = np.zeros((self.env.height, self.env.width), dtype=bool)
